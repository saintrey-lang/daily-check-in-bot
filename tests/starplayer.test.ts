...
import { STARPLAYER_CATEGORIES, starplayerSummary, validateSubmission, type StarplayerSubmission } from "../lib/starplayer/core";
...
function submission(id: string, userId: string, category: StarplayerSubmission["category"]): StarplayerSubmission {
  return {
    id, submittedAt: `2026-09-24T12:00:${id.padStart(2, "0")}Z`, userId,
...
describe("Starplayer submissions", () => {
  it("offers the three categories and optional link and file fields", () => {
  ...
  it("records readable rows in the separate Starplayer Sheet and ignores duplicate interaction IDs", async () => {
    ...
    expect(SUBMISSION_HEADERS).toHaveLength(12);
  });
